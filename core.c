...
PLUGIFY_EXPORT uintptr_t (*__polyhook_HookDetour)(uintptr_t, uint8_t, Vector*, int32_t, String*) = NULL;


PLUGIFY_EXPORT uintptr_t (*__polyhook_HookDetour2)(uintptr_t, String*) = NULL;


PLUGIFY_EXPORT uintptr_t (*__polyhook_HookVirtualTable)(uintptr_t, int32_t, uint8_t, Vector*, int32_t, String*) = NULL;


PLUGIFY_EXPORT uintptr_t (*__polyhook_HookVirtualTable2)(uintptr_t, uintptr_t, uint8_t, Vector*, int32_t, String*) = NULL;


PLUGIFY_EXPORT uintptr_t (*__polyhook_HookVirtualFunc)(uintptr_t, int32_t, uint8_t, Vector*, int32_t, String*) = NULL;


PLUGIFY_EXPORT uintptr_t (*__polyhook_HookVirtualFunc2)(uintptr_t, uintptr_t, uint8_t, Vector*, int32_t, String*) = NULL;
